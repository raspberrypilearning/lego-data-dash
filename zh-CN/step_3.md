...
<img src="images/sliderbuild1.jpg" alt="安装了蓝色支脚的构建板的图片。" />
...
接上两个灰色直支架，中间分隔一列。 
<img src="images/sliderbuild2.jpg" alt="安装了两个直支架的Build Plate的图片。" />
...
<img src="images/sliderbuild3.jpg" alt="安装了两个直支架和螺柱的Build Plate的图片。" />
...
<img src="images/sliderbuild4.jpg" alt="安装了两个直支架和螺柱的Build Plate的图片。" />
...
<img src="images/sliderbuild5.jpg" alt="安装了两个直支架和双头螺栓的Build Plate，外加一个短轴和齿轮的图片" />
...
<img src="images/sliderbuild6.jpg" alt="安装了两个直支架，双头螺栓以及一个短轴和齿轮的Build Plate的图片" />
...
<img src="images/sliderbuild11.jpg" alt="齿条、短轴和指示箭头的图像。" />
...
<img src="images/sliderbuild8.jpg" alt="安装了两个直支架，双头螺栓，一个短轴，一个齿轮以及滑动齿条的Build Plate的图片" />
...
<img src="images/sliderbuild9.jpg" alt="安装了两个直支架，双头螺栓，一个短轴，一个齿轮以及滑动齿条的Build Plate，外加一个马达的图片" />
...
<img src="images/sliderbuild10.jpg" alt="背面安装了马达的Build Plate的图片。" />
...
要对滑动指示器进行编程，您可以重复使用在 <a href="https://projects.raspberrypi.org/zh-CN/projects/lego-plotter">LEGO® Data plotter</a> 项目中编写的一些代码，因为它们使用相同的机制。
...
在（底部的）<strong x-id="1">Shell</strong> 窗口中，在三个箭头后面键入： 
<code>from buildhat import Motor</code> 并按 <kbd>回车</kbd>。 您应该会看到一个同样带有三个箭头的新行。
...
现在输入： 
<code>motor = = Motor('A')</code> 并按 <kbd>回车</kbd>。
...
键入： 
<code>motor.run_to_position(-180, 100)</code> 并按 <kbd>回车</kbd>。 在卡片上标记箭头指示的位置。 这是您的最小读数。
...
键入： 
<code>motor.run_to_position(180, 100)</code> 并按 <kbd>回车</kbd>。 在卡片上标记箭头指示的位置。 这是您的最大读数。
